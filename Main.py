...
def main():
    ...
    export_master_by_block_csv(sections, courses, section_rooms, "master_timetable.csv")
...
def export_master_by_block_csv(sections: dict, courses: dict, section_rooms: dict, out_path: str):
